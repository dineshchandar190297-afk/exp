...
export default function Simulator() {
  ...
  const handleSimulate = async (circuit: Circuit) => {
    ...
    const norm = Math.sqrt(
      statevector.reduce(
        (sum, amp) => sum + amp.real ** 2 + amp.imag ** 2,
        0
      )
    );
  ...
  return (
    ...
    >
      ...
      {/* BIG CENTERED ATOM UNDER HEADER */}
      <div className="relative z-10 flex justify-center items-center pt-8 pb-10">
        <div
      ...
      {/* MAIN CONTENT */}
      <main className="flex-1 container mx-auto px-4 pb-10 relative">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select gates and click on the canvas to build your
                    quantum circuit
                  </p>
                </div>
              </div>
